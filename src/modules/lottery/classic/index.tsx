...
const Classic: React.FC<ClassicProps> = ({ data }) => {
  return (
    <div className="bg-classic-100 rounded-md py-4">
      ...
      <div className="flex justify-between bg-classic-200 py-2 px-4">
