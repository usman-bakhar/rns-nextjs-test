...
const Cosmic: React.FC<CosmicProps> = ({ data }) => {
  return (
    <div className="bg-cosmic-100 rounded-md py-4">
      ...
      <div className="flex justify-between bg-cosmic-200 py-2 px-4">
